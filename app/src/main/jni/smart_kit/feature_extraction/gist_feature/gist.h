...
float *bw_gist_scaletab(image_t *src, int nblocks, int n_scale, const int *n_orientations, image_list_t *gabor);
 ...
 *    @param w Number of bins in x and y axis
 */
float *bw_gist(image_t *scr, int nblocks, int a, int b, int c, image_list_t *gabor);
...
GistData * create_gabor(int nscales, const int *orr, int width, int height, GistData *inputGistData);
